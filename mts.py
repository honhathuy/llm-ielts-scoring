...
os.environ["OLLAMA_NUM_PARALLEL"] = "12"
...
def process_prompts_in_batches(model, prompts, batch_size, description=""):
    all_responses = []
...
if __name__ == "__main__":
    ...
    turn_1_responses = process_prompts_in_batches(model, turn_1_prompts_str, BATCH_SIZE, "Turn 1: Quote Retrieval")
    ...
    turn_2_responses = process_prompts_in_batches(model, turn_2_prompts_str, BATCH_SIZE, "Turn 2: Scoring")
